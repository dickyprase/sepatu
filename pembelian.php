    ...
    <div class="col-lg-12 col-md-12">
        <div class="card" style="min-height: 485px">
            <div class="card-header card-header-text">
                <h4 class="card-title">List Pembelian</h4><br>
                <!-- Tombol untuk menampilkan modal-->
                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal"> <strong>+</strong> Pembelian</button>
                <a class="stretched-link text-success ml-4" href="riwayat_pembelian.php">Riwayat Pembelian</a>
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#edit<?= $data['kode_pembelian']; ?>">
                                Acc Stok
                            </button>
                            <!-- Button trigger modal Hapus -->
                            <a href="proses/inventori/delete_pembelian.php?kode=<?= $data['kode_pembelian'] ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus data Pembelian <?= $data['kode_pembelian'] ?> ?');">
                                Hapus
                    </a>
                        </td>
                    </tr>
            ...
            <form action="proses/inventori/add_pembelian.php" method="POST">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select required onchange="autofill()" name="nama" class="form-control" id="nama">
                    ...
                    <div class="mb-3">
                        ...
                        <select required name="supplier" class="form-control" id="supplier">
                    ...
                    <div class="mb-3">
                        ...
                        <input required type="text" class="form-control" name="harga" id="harga">
                    </div>
                    <div class="mb-3">
                        <label for="qty" class="col-form-label">Quantity</label>
                        <input required onkeyup="hitung()" type="text" class="form-control" name="qty" id="qty">
                    </div>
                    <div class="mb-3">
